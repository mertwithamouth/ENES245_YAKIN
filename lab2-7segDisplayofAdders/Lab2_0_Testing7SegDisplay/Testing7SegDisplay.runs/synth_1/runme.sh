...
HD_PWD='C:/Users/Mert Akin/Documents/GITHUB/lab2-7segDisplayofAdders/Lab2_0_Testing7SegDisplay/Testing7SegDisplay.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log simple7Seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source simple7Seg.tcl
