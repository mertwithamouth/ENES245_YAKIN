...
HD_PWD='C:/Users/Mert Akin/Documents/GITHUB/lab2-7segDisplayofAdders/Lab2_0_Testing7SegDisplay/Testing7SegDisplay.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log simple7Seg.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source simple7Seg.tcl -notrace
