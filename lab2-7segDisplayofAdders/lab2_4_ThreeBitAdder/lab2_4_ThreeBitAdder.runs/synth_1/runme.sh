...
HD_PWD='C:/Users/Mert Akin/Documents/GITHUB/lab2-7segDisplayofAdders/lab2_4_ThreeBitAdder/lab2_4_ThreeBitAdder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log hexTo7seg.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source hexTo7seg.tcl
