...
HD_PWD='C:/Users/Mert Akin/Documents/GITHUB/lab4-PriorityEncoders_ROM/3PriorityEncoder/3PriorityEncoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log priority_encoder_dataflow.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source priority_encoder_dataflow.tcl -notrace
