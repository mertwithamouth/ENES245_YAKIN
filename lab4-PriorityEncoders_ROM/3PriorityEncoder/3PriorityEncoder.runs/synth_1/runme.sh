...
HD_PWD='C:/Users/Mert Akin/Documents/GITHUB/lab4-PriorityEncoders_ROM/3PriorityEncoder/3PriorityEncoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log priority_encoder_dataflow.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source priority_encoder_dataflow.tcl
