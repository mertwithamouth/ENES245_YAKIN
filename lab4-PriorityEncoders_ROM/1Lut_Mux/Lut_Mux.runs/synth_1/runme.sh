...
HD_PWD='C:/Users/Mert Akin/Documents/GITHUB/lab4-PriorityEncoders_ROM/1Lut_Mux/Lut_Mux.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log LUT6_MUXCY_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source LUT6_MUXCY_test.tcl
