...
HD_PWD='C:/Users/Mert Akin/Documents/GITHUB/lab4-PriorityEncoders_ROM/4ROMpattern/4ROMpattern.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_16_3_behavior.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rom_16_3_behavior.tcl -notrace
