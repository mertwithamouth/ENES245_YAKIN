...
HD_PWD='C:/Users/Mert Akin/Documents/GITHUB/lab4-PriorityEncoders_ROM/4ROMpattern/4ROMpattern.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log rom_16_3_behavior.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source rom_16_3_behavior.tcl
