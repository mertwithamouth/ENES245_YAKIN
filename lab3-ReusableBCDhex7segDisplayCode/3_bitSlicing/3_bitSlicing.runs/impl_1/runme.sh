...
HD_PWD='C:/Users/FoersterGame/Documents/GitHub/ENES247/lab3-ReusableBCDhex7segDisplayCode/3_bitSlicing/3_bitSlicing.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log bitSlice.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source bitSlice.tcl -notrace
