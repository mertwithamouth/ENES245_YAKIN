...
HD_PWD='C:/Users/Scott Foerster/Documents/GitHub/ENES247/lab3-ReusableBCDhex7segDisplayCode/4_32bitsHexTo7segAnd16LEDs/3_32bitsHexTo7segAnd16LEDs.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log thirtyTwobitHexTo16LEDs.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source thirtyTwobitHexTo16LEDs.tcl
