...
HD_PWD='C:/Users/FoersterGame/Documents/GitHub/ENES247/lab3-ReusableBCDhex7segDisplayCode/0Decoder/0Decoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log decoder_3to8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source decoder_3to8.tcl
