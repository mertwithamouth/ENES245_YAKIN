...
HD_PWD='C:/Users/Mert Akin/Documents/GITHUB/lab5-Latches_FlipFlops/lab5_2_3/lab5_2_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log D_ff_sync_reset_behavior.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source D_ff_sync_reset_behavior.tcl
