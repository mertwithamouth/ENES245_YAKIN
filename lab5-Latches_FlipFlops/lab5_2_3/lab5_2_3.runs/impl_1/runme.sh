...
HD_PWD='C:/Users/Mert Akin/Documents/GITHUB/lab5-Latches_FlipFlops/lab5_2_3/lab5_2_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log D_ff_sync_reset_behavior.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source D_ff_sync_reset_behavior.tcl -notrace
