...
HD_PWD='C:/Users/Mert Akin/Documents/GITHUB/lab6-ShiftRegisters/lab6_1_5/lab6_1_5.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Serial_in_parallel_out_enable_behavior.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Serial_in_parallel_out_enable_behavior.tcl
