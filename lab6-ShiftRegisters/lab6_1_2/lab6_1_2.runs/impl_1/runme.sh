...
HD_PWD='C:/Users/Mert Akin/Documents/GITHUB/lab6-ShiftRegisters/lab6_1_2/lab6_1_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Register_with_synch_set_reset_load_behavior.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Register_with_synch_set_reset_load_behavior.tcl -notrace
