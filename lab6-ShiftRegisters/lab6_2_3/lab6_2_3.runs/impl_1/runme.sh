...
HD_PWD='C:/Users/Mert Akin/Documents/GITHUB/lab6-ShiftRegisters/lab6_2_3/lab6_2_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Four_bit_down_counter_with_load_enable_behavior.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Four_bit_down_counter_with_load_enable_behavior.tcl -notrace
