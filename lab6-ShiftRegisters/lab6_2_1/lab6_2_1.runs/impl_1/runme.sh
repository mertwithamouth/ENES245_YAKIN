...
HD_PWD='C:/Users/Mert Akin/Documents/GITHUB/lab6-ShiftRegisters/lab6_2_1/lab6_2_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Eight_bit_counter_with_T_flop_behave.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Eight_bit_counter_with_T_flop_behave.tcl -notrace
