...
#
# Generated by export_simulation on Thu May 16 14:29:56 -0400 2019
#
################################################################################
...
'-reset_run' switch to the './four_bit_counter_fabric.sh' script.

./four_bit_counter_fabric.sh -reset_run
...
./four_bit_counter_fabric.sh -noclean_files

For more information on the script, please type './four_bit_counter_fabric.sh -help'.
