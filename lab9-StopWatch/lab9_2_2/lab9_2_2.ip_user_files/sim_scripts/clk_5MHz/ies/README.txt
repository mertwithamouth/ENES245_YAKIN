...
#
# Generated by export_simulation on Wed May 22 10:24:21 -0400 2019
#
################################################################################
...
'-reset_run' switch to the './clk_5MHz.sh' script.

./clk_5MHz.sh -reset_run
...
./clk_5MHz.sh -noclean_files

For more information on the script, please type './clk_5MHz.sh -help'.
